package com.alibaba.datax.common.core.transport.record;
...
public class DefaultRecord implements Record {
	...
	public JSONObject toJsonObject() {
		...
		if(columns.isEmpty()){return jsonObject;}
		this.columns.forEach(o->{
			jsonObject.put(StrUtil.camel(o.getColumnName(),false),o.getRawData());
		});
		return jsonObject;
	}
