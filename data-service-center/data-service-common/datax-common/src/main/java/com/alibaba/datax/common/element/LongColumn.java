...
public class LongColumn extends Column {
	...
	public LongColumn (final String data,final String columnName){
		this(data);
		this.setColumnName(columnName);
	}

	public LongColumn(Long data,String columnName) {
		this(null == data ? (BigInteger) null : BigInteger.valueOf(data));
		this.setColumnName(columnName);
	}

	public LongColumn(Integer data,String columnName) {
		this(null == data ? (BigInteger) null : BigInteger.valueOf(data));
		this.setColumnName(columnName);
	}

	public LongColumn(BigInteger data,String columnName) {
		this(data, null == data ? 0 : 8);
		this.setColumnName(columnName);
	}

	private LongColumn(BigInteger data, int byteSize,String columnName) {
		super(data, Column.Type.LONG, byteSize);
		this.setColumnName(columnName);
	}
