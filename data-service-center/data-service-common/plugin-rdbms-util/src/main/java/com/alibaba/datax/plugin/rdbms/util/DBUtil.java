...
//                    throw new Exception(DBUtilErrorCode.JDBC_NULL.toString());
     ...
     * @throws SQLException if occurs SQLException.
     */
    public static ResultSet query(Connection conn, String sql, int fetchSize,List args)
            throws SQLException {
        // 默认3600 s 的query Timeout
        return query(conn, sql, fetchSize, Constant.SOCKET_TIMEOUT_INSECOND,args);
    }
    /**
     * a wrapped method to execute select-like sql statement .
     *
     ...
     * @throws SQLException
     */
    public static ResultSet query(Connection conn, String sql, int fetchSize, int queryTimeout, List args) throws SQLException {
        conn.setAutoCommit(false);
        PreparedStatement preparedStatement = conn.prepareStatement(sql,ResultSet.TYPE_FORWARD_ONLY,
                ResultSet.CONCUR_READ_ONLY);
        preparedStatement.setFetchSize(fetchSize);
        preparedStatement.setQueryTimeout(queryTimeout);
        return query(preparedStatement, args);
     ...
     * @throws SQLException if occurs SQLException.
     */
    public static ResultSet query(PreparedStatement preparedStatement,List args)
            throws SQLException {
        if (args != null) {
    ...
    public static ResultSet query(Connection conn, String sql,List args)
            throws SQLException {
