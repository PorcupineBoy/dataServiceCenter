...
public enum DataBaseType {
    ...
    public static DataBaseType toDataBaseType(String modeName) {
        for (DataBaseType mode : DataBaseType.values()) {
            if (mode.typeName.equals(modeName)) {
                return mode;
            }
        }
        throw new RuntimeException("no such DataBaseType :" + modeName);
    }
